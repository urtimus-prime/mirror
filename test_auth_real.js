...
async function run() {
    console.log('1. Initiating Authentication via https://mirror.soulcats.xyz/api/auth/challenge?provider=github.com&username=urtimus-prime');
    const chalRes = await fetch('https://mirror.soulcats.xyz/api/auth/challenge?provider=github.com&username=urtimus-prime');
    ...
    try {
        fs.unlinkSync('/tmp/chal_urtimus.txt.sig');
    }
    catch (e) { }
